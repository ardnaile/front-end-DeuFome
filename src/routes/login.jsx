      ...
      <form className="max-w-xl mx-auto flex items-center h-screen w-screen justify-center bg-transparent" >
       <div className="bg-white shadow-md rounded-2xl w-80 px-10 py-10 pt-10 pb-10">
        ...
        <div>
             ...
             <input value={password} onChange={handlePasswordChange} required className='block transition duration-200 ease-in-out focus:outline-none w-full bg-gray-50 border border-gray-800 rounded px-2 py-1 text-base text-gray-800 placeholder:text-gray-300'  type="password" placeholder='Digite sua senha' />
        </div>
        ...
        <div>
            <Link to="/Home">
              <button id="send" type="submit" onClick={handleSubmit} className='w-full text-sm bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded shadow text-white mt-8'>Logar</button>
            </Link>

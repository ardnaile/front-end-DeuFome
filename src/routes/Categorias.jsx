            ...
            <Link to="/Doce">
              <div className='relative w-96'>
                <img
                  ...
                  alt="Doce"
                />
                <p className="text-white text-8xl font-bold text-roboto absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-0 hover:opacity-100 transition duration-300">Doce</p>
              </div>
            </Link>
          </div>
            ...
            <Link to="/Pizza-lista">
              <div className='relative w-96'>
                <img
                  ...
                  alt="Salada"
                />
                <p className="text-white text-8xl font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-0 hover:opacity-100 transition duration-300">Salada</p>
                </div>
            </Link>
        </div>
            ...
            <Link to="/Massas-lista">
                <div className='relative w-96'>
                    <img
                        ...
                        alt="Carne"
                        />
                        <p className="text-white text-8xl font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-0 hover:opacity-100 transition duration-300">Carne</p>
                    </div>
                </Link>
            </div>
                ...
                <Link to="/Doce">
                    <div className='relative w-96 h-64'>
                        <img
                            ...
                            alt="Sushi"
                        />
                        <p className="text-white text-8xl font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-0 hover:opacity-100 transition duration-300">Sushi</p>
                    </div>
                </Link>
            </div>
                ...
                <Link to="/Doce">
                    <div className='relative w-96'>
                        <img
                            ...
                            alt="Peixe"
                        />
                        <p className="text-white text-8xl font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-0 hover:opacity-100 transition duration-300">Peixe</p>
                    </div>
                </Link>
            </div>
            ...
            <Link to="/Doce">
                <div className='relative w-96'>
                    <img
                            ...
                            alt="Cerveja"
                        />
                        <p className="text-white text-8xl font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-0 hover:opacity-100 transition duration-300">Cerveja</p>
                    </div>
                </Link>
            </div>
                ...
                <Link to="/Doce">
                    <div className='relative w-96'>
                        <img
                            ...
                            alt="Sopa"
                        />
                        <p className="text-white text-8xl font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-0 hover:opacity-100 transition duration-300">Sopa</p>
                    </div>
                </Link>
            </div>
